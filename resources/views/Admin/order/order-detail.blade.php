                                    ...
                                    <div class="track-order-list">
                                        <ul class="list-unstyled">
                                            <li class="completed">
                                                ...
                                                <p class="text-muted">April 21 2019 <small class="text-muted">07:22
                                                        AM</small> </p>
                                            </li>
                                            <li class="completed">
                                        ...
                                        <table class="table table-bordered table-centered mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><img src="{{ asset('assets/images/products/product-1.png') }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="{{ asset('assets/images/products/product-5.png') }}"
                                                            alt="product-img" height="32"></td>
                                                    <td>2</td>
                                                    <td>$46</td>
                                                    <td>$92</td>
                                                ...
                                                <tr>
                                                    <th scope="row">Red Hoodie for men</th>
                                                    <td><img src="{{ asset('assets/images/products/product-3.png') }}"
                                                            alt="product-img" height="32"></td>
                                                    <td>1</td>
                                                    <td>$46</td>
                                                    <td>$46</td>
                                                ...
                                                <tr>
                                                    <th scope="row" colspan="4" class="text-right">Shipping Charge :
                                                    </th>
                                                    <td>$24</td>
                                                </tr>
                                                <tr>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        <li>
                                            <p class="mb-2"><span class="font-weight-semibold mr-2">Payment Type:</span>
                                                Credit Card</p>
                                            <p class="mb-2"><span class="font-weight-semibold mr-2">Provider:</span>
                                                Visa ending in 2851</p>
                                            <p class="mb-2"><span class="font-weight-semibold mr-2">Valid Date:</span>
                                                02/2020</p>
