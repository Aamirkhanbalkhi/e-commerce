                                        ...
                                        <div class="col-lg-4">
                                            <div class="nav nav-pills flex-column navtab-bg nav-pills-tab text-center"
                                                ...
                                                <a class="nav-link mt-2 py-2" id="custom-v-pills-payment-tab"
                                                    data-toggle="pill" href="#custom-v-pills-payment" role="tab"
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-centered table-nowrap mb-0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="ecommerce-product-detail.html"
                                                                        class="text-body font-weight-semibold">Polo Navy
                                                                        blue T-shirt</a>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <img src="{{ asset('assets/images/products/product-2.png') }}"
                                                                        alt="product-img" title="product-img"
                                                                        class="rounded" height="48" />
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <a href="ecommerce-product-detail.html"
                                                                        class="text-body font-weight-semibold">Red
                                                                        Hoodie for men</a>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <img src="{{ asset('assets/images/products/product-3.png') }}"
                                                                        alt="product-img" title="product-img"
                                            ...
                                            <div class="tab-content p-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <form>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="billing-first-name">First
                                                                            Name</label>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="billing-phone">Phone <span
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label for="billing-town-city">Town /
                                                                            City</label>
                                                                        <input class="form-control" type="text"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="custom-control custom-checkbox">
                                                                            ...
                                                                            <label class="custom-control-label"
                                                                                for="customCheck2">Ship to different
                                                                                address ?</label>
                                                                        </div>
                                                                    </div>

                                                                    <div class="form-group mt-3">
                                                                        <label for="example-textarea">Order
                                                                            Notes:</label>
                                                            ...
                                                            <div class="row mt-4">
                                                                <div class="col-sm-6">
                                                                    <a href="{{ route('shopcart') }}"
                                                                        ...
                                                                        <i class="mdi mdi-arrow-left"></i> Back to
                                                                        Shopping Cart </a>
                                                                </div> <!-- end col -->
                                                                <div class="col-sm-6">
                                                ...
                                                <div class="tab-pane fade" id="custom-v-pills-shipping" role="tabpanel"
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="border p-3 rounded mb-3 mb-md-0">
                                                                    ...
                                                                    <p class="mb-2"><span
                                                                            class="font-weight-semibold mr-2">Address:</span>
                                                                        3559 Roosevelt Wilson Lane San Bernardino, CA
                                                                        92405</p>
                                                                    <p class="mb-2"><span
                                                                            class="font-weight-semibold mr-2">Phone:</span>
                                                                        (123) 456-7890</p>
                                                                    <p class="mb-0"><span
                                                                            class="font-weight-semibold mr-2">Mobile:</span>
                                                                        (+01) 12345 67890</p>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="border p-3 rounded mb-3">
                                                                    ...
                                                                    <p class="mb-0 pl-3 pt-1">Estimated 5-7 days
                                                                        shipping (Duties and tax may be due upon
                                                                        delivery)</p>
                                                                </div>
                                                                ...
                                                                <div class="border p-3 rounded">
                                                                    ...
                                                                    <p class="mb-0 pl-3 pt-1">Estimated 1-2 days
                                                                        shipping (Duties and tax may be due upon
                                                                        delivery)</p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row mt-4">
                                                            <div class="col-sm-6">
                                                                <a href="{{ route('shopcart') }}" class="btn btn-secondary">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="border p-3 mb-3 rounded">
                                                            ...
                                                            <div
                                                                ...
                                                                <input type="radio" id="BillingOptRadio2"
                                                                    name="billingOptions" class="custom-control-input">
                                                                <label
                                                                    class="custom-control-label font-16 font-weight-bold"
                                                        ...
                                                        <div class="border p-3 mb-3 rounded">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        <label for="card-expiry-date">Expiry
                                                                            date</label>
                                                        ...
                                                        <div class="border p-3 mb-3 rounded">
                                                            <div class="float-right">
                                                                <i
                                                                    class="fas fa-money-bill-alt font-24 text-primary"></i>
                                                            </div>
                                                            <div
                                                                class="custom-control custom-radio custom-control-inline">
