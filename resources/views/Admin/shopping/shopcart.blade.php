                                                    ...
                                                    <tbody>
                                                            ...
                                                            <td>
                                                                ...
                                                                <p class="m-0 d-inline-block align-middle font-16">
                                                                    <a href="ecommerce-product-detail.html"
                                                                        class="text-reset font-family-secondary">Polo
                                                                        Navy blue T-shirt</a>
                                                                    <br>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <p class="m-0 d-inline-block align-middle font-16">
                                                                    <a href="ecommerce-product-detail.html"
                                                                        class="text-body font-family-secondary">Brown
                                                                        Hoodie for men</a>
                                                                    <br>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <p class="m-0 d-inline-block align-middle font-16">
                                                                    <a href="ecommerce-product-detail.html"
                                                                        class="text-body font-family-secondary">Designer
                                                                        Awesome T-Shirt</a>
                                                                    <br>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img src="{{ asset('assets/images/products/product-5.png') }}"
                                                                    alt="contact-img" title="contact-img"
                                                                    class="rounded mr-3" height="48" />
                                                                <p class="m-0 d-inline-block align-middle font-16">
                                                                    <a href="ecommerce-product-detail.html"
                                                                        class="text-body font-family-secondary">Half
                                                                        Sleeves Tshirt</a>
                                                                    <br>
                                                                    <small class="mr-2"><b>Size:</b> Large </small>
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="text-sm-right">
                                                        <a href="{{ route('checkout') }}" class="btn btn-success"><i
