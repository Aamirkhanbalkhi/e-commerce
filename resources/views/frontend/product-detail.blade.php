                    ...
                    <div class="tpdetails__area mr-60 pb-30">
                        <div class="tpdetails__product mb-30">
                            <div class="tpdetails__title-box">
                                <h3 class="tpdetails__title">{{$productDetail->title}}</h3>
                                        ...
                                        <div class="tpproduct-details__nab">
                                            <div class="tab-content" id="nav-tabContents">
                                                ...
                                                <div class="tab-pane fade w-img" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab" tabindex="0">
                                                    <img src="{{asset('uploads/'. $productDetail->image_url_3)}}" alt="">
                                                    <!-- <div class="tpproduct__info bage">
                                                        <span class="tpproduct__info-hot bage__hot">HOT</span>
                                                    </div> -->
                                                </div>
                                            ...
                                            <nav>
                                                <div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
                                                    @if ($productDetail->image_url_1 && $productDetail->image_url_2)
                                                    ...
                                                    @if ($productDetail->image_url_3)
                                                    <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">
                                                        <img src="{{ asset('uploads/'. $productDetail->image_url_3) }}" alt="">
                                                    </button>
                                                    @endif
                                                    @elseif ($productDetail->image_url_1)
                                                    <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">
                                                        <img src="{{ asset('uploads/'. $productDetail->image_url_1) }}" alt="">
                                                    </button>
                                                    @if ($productDetail->image_url_2)
                                                    <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">
                                                        <img src="{{ asset('uploads/'. $productDetail->image_url_2) }}" alt="">
                                                    </button>
                                                    @endif
                                                    @elseif ($productDetail->image_url_2)
                                                    ...
                                                    @endif
                                                    @elseif ($productDetail->image_url_3)
                                        ...
                                        <div class="product__details">
                                            ...
                                            <div class="product__details-stock mb-25">
                                                <ul>
                                                    ...
                                                    <li>Categories: <span>{{$productDetail->category->category_name}} </span></li>
                            ...
                            <div class="tpdescription__box-center d-flex align-items-center justify-content-center">
                                <nav>
                                    <div class="nav nav-tabs" role="tablist">
                                        ...
                                        <!-- <button class="nav-link" id="nav-info-tab" data-bs-toggle="tab" data-bs-target="#nav-information" type="button" role="tab" aria-controls="nav-information" aria-selected="false">ADDITIONAL
                                            INFORMATION</button> -->
                                    </div>
                                </nav>
                            </div>
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-description" role="tabpanel" aria-labelledby="nav-description-tab" tabindex="0">
                                    ...
                                    <div class="tpdescription__product-wrapper mt-30 mb-30 d-flex justify-content-between align-items-center">
                                        <div class="tpdescription__product-info">
                                            ...
                                            <p>Lemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut <br> fugit,
                                                sed quia consequuntur magni dolores eos qui ratione voluptatem <br> sequi
                                                nesciunt.</p>
                                        </div>
                                    ...
                                    <div class="tpdescription__video">
                                        ...
                                        <p>Duis semper erat mauris, sed egestas purus commodo. Cras imperdiet est in nunc
                                            tristique lacinia. Nullam aliquam mauris eu accumsan tincidunt. Suspendisse velit
                                            ex, aliquet vel ornare vel, dignissim a tortor. Ut enim ad minim veniam, quis
                                ...
                                <!-- <div class="tab-pane fade" id="nav-information" role="tabpanel" aria-labelledby="nav-info-tab" tabindex="0">
                                    ...
                                    <div class="tpdescription__product-wrapper mt-30 mb-30 d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="tpdescription__product-thumb">
                                            <img src="{{asset('webside/assets/img/product/product-single-1.png')}}" alt="">
                                        </div>
                                    </div>
                                    <div class="tpdescription__video">
                                        <h5 class="tpdescription__product-title">PRODUCT DETAILS</h5>
                        ...
                        <div class="swiper-slide">
                            <div class="tpproduct p-relative">
                                <div class="tpproduct__thumb p-relative text-center">
                                    <a href="#"><img src="{{asset('webside/assets/img/product/products29-min.jpg')}}" alt=""></a>
                                    <a class="tpproduct__thumb-img" href="shop-details.html"><img src="{{asset('webside/assets/img/product/products30-min.jpg')}}" alt=""></a>
                                    <div class="tpproduct__info bage">
                                ...
                                <div class="tpproduct__content">
                                    ...
                                    <h4 class="tpproduct__title">
                                        <a href="shop-details.html">Mangosteen Organic From VietNamese</a>
                                    </h4>
